        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="{{ route ('addmisi')}}" class="btn btn-primary">Add</a>
                        ...
                        <table id="misi_table" class="table dt-responsive nowrap w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary" href="{{ route ('editmisi',$row->id)}}"><i class="dripicons-pencil"></i></a>
