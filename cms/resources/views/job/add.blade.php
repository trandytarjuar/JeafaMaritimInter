    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Form Add Job</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                        ...
                        <div class="tab-pane show active" id="custom-styles-preview">
                            <form class="needs-validation" novalidate>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea type="text" class="form-control" id="qualifition" placeholder="qualifition" required></textarea>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label" for="deskripsi">Job Description</label>
                                    <textarea type="text" class="form-control" id="deskripsi" placeholder="qualifition" required></textarea>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <textarea type="text" class="form-control" id="benefite" placeholder="benefite" required></textarea>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
