...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Form Add Tagline</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Add Tagline</h4>
                        ...
                        <div class="tab-pane show active" id="custom-styles-preview">
                            <form class="needs-validation" novalidate>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="tagline" placeholder="tagline" required="">
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
                                ...
                                <a class="btn btn-primary" onclick="submittagline()">Add</a>
                            </form>
                        </div> <!-- end preview-->
